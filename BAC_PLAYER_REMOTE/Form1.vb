...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs)
        ...
        'Dim taskServices As New Microsoft.Win32.TaskScheduler.TaskService("MAILSERVER", "Administrator", "MAILSERVER\Administrator", "MailP@ssword", False)


        Dim taskServices As New Microsoft.Win32.TaskScheduler.TaskService()

        If taskServices.GetFolder("BACPLAYER") Is Nothing Then
            taskServices.RootFolder.CreateFolder("BACPLAYER")
        End If


        Dim task As Microsoft.Win32.TaskScheduler.TaskDefinition = taskServices.NewTask
        task.RegistrationInfo.Description = "Thu nghiem taskse rvices 2222"
        task.RegistrationInfo.Date = Today


        Dim trigger As New Microsoft.Win32.TaskScheduler.WeeklyTrigger
        'trigger.Repetition.Interval = New TimeSpan(9, 30, 0)
        trigger.DaysOfWeek = _
            DaysOfTheWeek.Monday Or _
            DaysOfTheWeek.Tuesday Or _
            DaysOfTheWeek.Wednesday Or _
            DaysOfTheWeek.Thursday Or _
            DaysOfTheWeek.Friday Or _
            DaysOfTheWeek.Saturday

        trigger.StartBoundary = New Date(Today.Year, Today.Month, Today.Day, 15, 58, 0)

        task.Triggers.Add(trigger)


        Dim action As New Microsoft.Win32.TaskScheduler.ExecAction
        action.Path = "E:\BACPLAYER\BACPLAYER\BAC_PLAYER_MP3\bin\Debug\BAC_PLAYER_MP3.exe"
        action.Arguments = """E:\BACPLAYER\BACPLAYER\BAC_PLAYER_MP3\bin\Debug\NhacMp3\1.mp3;E:\BACPLAYER\BACPLAYER\BAC_PLAYER_MP3\bin\Debug\NhacMp3\3.mp3;E:\BACPLAYER\BACPLAYER\BAC_PLAYER_MP3\bin\Debug\NhacMp3\4.mp3"""
        task.Actions.Add(action)


        taskServices.GetFolder("BACPLAYER").RegisterTaskDefinition("Sang 2", task)
    ...
    Private Sub btnBatDau_Click(sender As System.Object, e As System.EventArgs) Handles btnBatDau.Click
        If isUpdate Then ' Cap nhat tac vu
            ...
            trig.StartBoundary = New DateTime(Today.Year, Today.Month, Today.Day, txtBatDau.Value.Hour, txtBatDau.Value.Minute, 0)
